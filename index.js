...
const themeModal = document.querySelector('.costomoize-theme');
...
const closeThemeModal = (e) => {
    if (e.target.classList.contains('costomoize-theme')) {
...
Bg1.addEventListener('click', () => {
    ...
    // remove active class from the onther
...
Bg2.addEventListener('click', () => {
    ...
    //remove active class form the onther
